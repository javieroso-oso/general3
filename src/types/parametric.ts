...
export interface ParametricParams {
  ...
  skinTextureMode: 'off' | 'fuzz' | 'knurl' | 'scales' | 'ribs' | 'brushed' | 'pixel' | 'hammered' | 'threads';
  skinTextureAmplitude: number;       // 0..1.2 mm
...
const createDefaultParams = (overrides: Partial<ParametricParams> = {}): ParametricParams => {
  ...
  skinTextureMode: 'off',
  skinTextureAmplitude: 0.4,
  skinTextureDensity: 1,
  skinTextureDirection: 'both',
  skinTextureStartHeightPct: 0,
  skinTextureEndHeightPct: 0,
