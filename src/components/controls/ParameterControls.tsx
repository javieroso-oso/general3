    ...
    >
      ...
      <Section title="Dimensions" defaultOpen={true}>
        <ParameterSlider
          label="Height"
          value={params.height}
          min={exhibitMode ? 60 : printConstraints.minHeight}
          max={exhibitMode ? 180 : printConstraints.maxHeight}
          step={5}
          unit="mm"
      ...
      {!exhibitMode && <div className="bg-secondary/50 rounded-lg p-3 space-y-3">
        ...
        <div className="text-xs text-muted-foreground">
          Dibuja o sube una foto y se convertirá en grabado directo sobre la superficie.
        </div>
